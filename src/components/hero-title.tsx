...
const HeroTitle = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[min(36rem,calc(100vw-2.5rem))] text-lta-dark-green [-webkit-text-stroke:2px_rgba(255,255,255,0.92)] [paint-order:stroke_fill] [text-shadow:0_1px_0_rgba(255,255,255,0.78),0_10px_26px_rgba(0,72,81,0.18)] sm:[-webkit-text-stroke:4px_rgba(255,255,255,0.92)] sm:[text-shadow:0_1px_0_rgba(255,255,255,0.82),0_18px_44px_rgba(0,72,81,0.24)]">
